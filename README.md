...
- Use the file `expenses_data.json` as a persistent (read AND write) data source for the backend: https://github.com/Logikfabriken/OH_NO_We_are_out_of_coffee/blob/main/expenses_data.json
